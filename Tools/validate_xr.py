...
for marker in ("CommonUsages.primary2DAxis", "CommonUsages.triggerButton", "CommonUsages.gripButton", "SendHapticImpulse", "leftSelect", "SmoothTurn", "Rotate(0, turnAxis.x", "XRHandSubsystem", "ApplyRoomScale", "ODYSSEY_XR_RECOVERED"):
