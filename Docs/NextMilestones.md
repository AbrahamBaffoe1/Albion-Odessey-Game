...
6. **Interface and accessibility.** Per-action keyboard rebinding is shipped in 0.15. Add controller glyphs, audio descriptions and a complete caption track for media.
