...
namespace AlbionOdyssey
{
    public sealed class WalkableBuildingSmoke : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            try
            {
                var robinson = buildings.Building("16"); var bonta = buildings.Building("1");
                Require(robinson != null && bonta != null, "Robinson or Bonta was not registered");
                ...
                Write("{\"passed\":true,\"robinsonFloors\":4,\"robinsonDoors\":" + robinson.Doors.Count + ",\"bontaFloors\":1,\"bontaDoors\":" + bonta.Doors.Count + ",\"history\":true}"); Debug.Log("WALKABLE_BUILDING_SMOKE_OK"); Application.Quit(0);
            }
