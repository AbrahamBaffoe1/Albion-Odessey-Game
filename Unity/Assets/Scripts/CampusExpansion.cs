...
namespace AlbionOdyssey
{
    public sealed class CampusExpansion : MonoBehaviour
    {
        ...
        void InitStyles()
        {
            ...
            heading=new GUIStyle(GUI.skin.label){font=AlbionUITheme.DisplayFont,fontSize=AlbionUITheme.TextSize(28),fontStyle=FontStyle.Bold,richText=false};text=new GUIStyle(GUI.skin.label){font=AlbionUITheme.BodyFont,fontSize=AlbionUITheme.TextSize(17),wordWrap=true,richText=false};small=new GUIStyle(text){font=AlbionUITheme.BodyFont,fontSize=AlbionUITheme.TextSize(14)};
            button=new GUIStyle(GUI.skin.button){font=AlbionUITheme.BodyFont,fontSize=AlbionUITheme.TextSize(15),wordWrap=true,richText=false,border=new RectOffset(),padding=new RectOffset(12,12,5,5)};
