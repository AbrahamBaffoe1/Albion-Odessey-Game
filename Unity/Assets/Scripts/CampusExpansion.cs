...
namespace AlbionOdyssey
{
    ...
    {
        public OdysseyGame game;public readonly List<CampusCar> cars=new List<CampusCar>();
        ...
        {
            game=owner;CampusGeometry.Build();game.player.CreateAvatar();game.player.thirdPerson=!OdysseySmoke.Enabled;
