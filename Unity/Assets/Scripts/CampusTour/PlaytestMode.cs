...
namespace AlbionOdyssey
{
    ...
    {
        static readonly string[] Flags={"-odysseySmoke","-tourSmoke","-shellSmoke","-blueprintSmoke","-combinedSmoke","-craftSmoke","-accountSmoke","-presentationSmoke","-vehicleSmoke","-impactSmoke"};
