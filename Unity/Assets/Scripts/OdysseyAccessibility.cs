...
namespace AlbionOdyssey
{
    ...
    public sealed class OdysseyAccessibility : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            float x = Mathf.Clamp((w - 780) * .5f, safe.xMin + 24, safe.xMax - 780 - 24); GUI.Label(new Rect(x, 70, 740, 48), "ACCESSIBILITY & CONTROLS", title); GUI.Label(new Rect(x, 125, 740, 54), "F4 opens this panel. Settings are saved for this Mac. Controller left stick and A/Cross jump are supported.", text);
