...
namespace AlbionOdyssey
{
    public sealed class CampusLife : MonoBehaviour
    {
        ...
        public void Travel(int destination)
        {
            ...
            game.notice=destination==1?"Enter the classroom. K opens courses. H opens the history lesson.":destination==2?"Enter the pavilion. Stand by a display and press H.":destination==3?"Your personal campus. F2 opens the building tools.":"Legacy Hall: aim at golden memories and press "+OdysseyAccessibility.InteractLabel+".";
        }
        ...
        void OnGUI()
        {
            ...
            else if(panel=="welcome")
            {
                ...
                Label(left,739,1110,27,"Vehicle: Car Concept · © 2024 DGG · Eric Chadwick · CC BY 4.0 · adapted for Albion Odyssey",muted);
            }
            else if(panel=="map")
            {
